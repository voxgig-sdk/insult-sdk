...
class InsultDirectTest extends TestCase
{
    public function test_direct_load_insult(): void
    {
        $setup = insult_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-insult", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
