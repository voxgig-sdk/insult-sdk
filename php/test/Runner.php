...
class InsultTestRunner
{
    ...
    {
        $live = self::getenv('INSULT_TEST_LIVE');
        $override = self::getenv('INSULT_TEST_OVERRIDE');
        ...
        $explain = self::getenv('INSULT_TEST_EXPLAIN');
...
class_alias('InsultTestRunner', 'Runner');
class_alias('InsultHelpers', 'Helpers');
