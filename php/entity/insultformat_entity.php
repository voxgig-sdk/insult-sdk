...
// Insult SDK Insultformat entity
...
class InsultformatEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InsultformatEntity($this->_client, $opts);
    }

    /**
     * @param Insultformat|array $args Insultformat data (assoc-array) to store.
     */
    ...
    /**
     * @return Insultformat|array The current Insultformat data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Insultformat fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Insultformat fields).
     */
    ...
    /**
     * Load a single Insultformat.
     *
     * @param InsultformatLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed InsultformatLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Insultformat|array The loaded Insultformat as an assoc-array at the
