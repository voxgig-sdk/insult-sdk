...
class AdjectiveEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdjectiveEntity($this->_client, $opts);
    }

    /**
     * @param Adjective|array $args Adjective data (assoc-array) to store.
     */
    ...
    /**
     * @return Adjective|array The current Adjective data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Adjective fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Adjective fields).
     */
    ...
    /**
     * Load a single Adjective.
     *
     * @param AdjectiveLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdjectiveLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Adjective|array The loaded Adjective as an assoc-array at the
