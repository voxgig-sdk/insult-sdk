...
class InsultEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InsultEntity($this->_client, $opts);
    }

    /**
     * @param Insult|array $args Insult data (assoc-array) to store.
     */
    ...
    /**
     * @return Insult|array The current Insult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Insult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Insult fields).
     */
    ...
    /**
     * Load a single Insult.
     *
     * @param InsultLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed InsultLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Insult|array The loaded Insult as an assoc-array at the
