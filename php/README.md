...
The PHP SDK for the Insult API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Adjective(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->Insult(null)->load(
    ["id" => "test01"], null
);
...
The main class (`insult_sdk.php`) exports the SDK class
