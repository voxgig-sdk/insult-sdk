...
class InsultSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $utility = new InsultUtility();
        $this->_utility = $utility;

        $config = InsultConfig::make_config();
        ...
        $feature_opts = InsultHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = InsultHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ($utility->feature_add)($this->_rootctx, InsultFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return InsultUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = InsultHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = InsultHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = InsultHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new InsultError($op . "_allow",
                "InsultSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = InsultHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new InsultError("graphql_error",
                "InsultSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Adjective($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_adjective === null) {
                $this->_adjective = new AdjectiveEntity($this, null);
            }
            return $this->_adjective;
        }
        return new AdjectiveEntity($this, $data);
    }
    ...
    public function Adjectiveformat($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_adjectiveformat === null) {
                $this->_adjectiveformat = new AdjectiveformatEntity($this, null);
            }
            return $this->_adjectiveformat;
        }
        return new AdjectiveformatEntity($this, $data);
    }
    ...
    public function Insult($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_insult === null) {
                $this->_insult = new InsultEntity($this, null);
            }
            return $this->_insult;
        }
        return new InsultEntity($this, $data);
    }
    ...
    public function Insultformat($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_insultformat === null) {
                $this->_insultformat = new InsultformatEntity($this, null);
            }
            return $this->_insultformat;
        }
        return new InsultformatEntity($this, $data);
    }
