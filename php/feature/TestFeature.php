...
// Insult SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class InsultTestFeature extends InsultBaseFeature
{
    ...
    public function init(InsultContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (InsultContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (InsultContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(InsultContext $ctx, $op, $args): array
    {
