...
class InsultRbacFeature extends InsultBaseFeature
{
    ...
    private function _required(InsultContext $ctx): ?string
    {
    ...
    private function _reject(InsultContext $ctx, string $required): void
    {
    ...
    private function _track(InsultContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
