...
const testSeed = `map[string]any{"entity": map[string]any{"adjective": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "adjectiveformat": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "insult": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "insultformat": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
