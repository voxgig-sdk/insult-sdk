...
type AdjectiveformatEntity struct {
	name    string
...
func NewAdjectiveformatEntity(client *core.InsultSDK, entopts map[string]any) *AdjectiveformatEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdjectiveformatEntity) GetName() string { return e.name }
...
func (e *AdjectiveformatEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdjectiveformatEntity) Deleted() bool {
	return e.deleted
}


func (e *AdjectiveformatEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdjectiveformatEntity(e.client, opts)
}

func (e *AdjectiveformatEntity) Data(args ...any) any {
...
func (e *AdjectiveformatEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *AdjectiveformatEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdjectiveformatEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AdjectiveformatEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AdjectiveformatEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdjectiveformatEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdjectiveformatEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
