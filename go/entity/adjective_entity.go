...
func NewAdjectiveEntity(client *core.InsultSDK, entopts map[string]any) *AdjectiveEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdjectiveEntity) GetName() string { return e.name }
...
func (e *AdjectiveEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdjectiveEntity) Deleted() bool {
	return e.deleted
}


func (e *AdjectiveEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdjectiveEntity(e.client, opts)
}

func (e *AdjectiveEntity) Data(args ...any) any {
...
func (e *AdjectiveEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Adjective; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AdjectiveEntity) DataTyped(data ...Adjective) Adjective {
	if len(data) > 0 {
		return typedFrom[Adjective](e.Data(asMap(data[0])))
	}
	return typedFrom[Adjective](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Adjective (all fields
// optional at the wire level).
func (e *AdjectiveEntity) MatchTyped(match ...Adjective) Adjective {
	if len(match) > 0 {
		return typedFrom[Adjective](e.Match(asMap(match[0])))
	}
	return typedFrom[Adjective](e.Match())
}
...
func (e *AdjectiveEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdjectiveEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AdjectiveLoadMatch and returns an Adjective. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AdjectiveEntity) LoadTyped(reqmatch AdjectiveLoadMatch, ctrl map[string]any) (Adjective, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Adjective{}, err
	}
	return typedFrom[Adjective](res), nil
}



func (e *AdjectiveEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AdjectiveEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AdjectiveEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdjectiveEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdjectiveEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
