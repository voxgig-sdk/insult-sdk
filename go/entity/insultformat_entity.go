...
type InsultformatEntity struct {
	name    string
	client  *core.InsultSDK
...
func NewInsultformatEntity(client *core.InsultSDK, entopts map[string]any) *InsultformatEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InsultformatEntity) GetName() string { return e.name }
...
func (e *InsultformatEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InsultformatEntity) Deleted() bool {
	return e.deleted
}


func (e *InsultformatEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInsultformatEntity(e.client, opts)
}

func (e *InsultformatEntity) Data(args ...any) any {
...
func (e *InsultformatEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Insultformat; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InsultformatEntity) DataTyped(data ...Insultformat) Insultformat {
	if len(data) > 0 {
		return typedFrom[Insultformat](e.Data(asMap(data[0])))
	}
	return typedFrom[Insultformat](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Insultformat (all fields
// optional at the wire level).
func (e *InsultformatEntity) MatchTyped(match ...Insultformat) Insultformat {
	if len(match) > 0 {
		return typedFrom[Insultformat](e.Match(asMap(match[0])))
	}
	return typedFrom[Insultformat](e.Match())
}
...
func (e *InsultformatEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InsultformatEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InsultformatLoadMatch and returns an Insultformat. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *InsultformatEntity) LoadTyped(reqmatch InsultformatLoadMatch, ctrl map[string]any) (Insultformat, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Insultformat{}, err
	}
	return typedFrom[Insultformat](res), nil
}



func (e *InsultformatEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *InsultformatEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InsultformatEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InsultformatEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InsultformatEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
