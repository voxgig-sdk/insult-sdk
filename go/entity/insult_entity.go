...
func NewInsultEntity(client *core.InsultSDK, entopts map[string]any) *InsultEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InsultEntity) GetName() string { return e.name }
...
func (e *InsultEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InsultEntity) Deleted() bool {
	return e.deleted
}


func (e *InsultEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInsultEntity(e.client, opts)
}

func (e *InsultEntity) Data(args ...any) any {
...
func (e *InsultEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Insult; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InsultEntity) DataTyped(data ...Insult) Insult {
	if len(data) > 0 {
		return typedFrom[Insult](e.Data(asMap(data[0])))
	}
	return typedFrom[Insult](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Insult (all fields
// optional at the wire level).
func (e *InsultEntity) MatchTyped(match ...Insult) Insult {
	if len(match) > 0 {
		return typedFrom[Insult](e.Match(asMap(match[0])))
	}
	return typedFrom[Insult](e.Match())
}
...
func (e *InsultEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InsultEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InsultLoadMatch and returns an Insult. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *InsultEntity) LoadTyped(reqmatch InsultLoadMatch, ctrl map[string]any) (Insult, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Insult{}, err
	}
	return typedFrom[Insult](res), nil
}



func (e *InsultEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *InsultEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InsultEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InsultEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InsultEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
