...
func (sdk *InsultSDK) OptionsMap() map[string]any {
...
func (sdk *InsultSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *InsultSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *InsultSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *InsultSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *InsultSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *InsultSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("InsultSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *InsultSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *InsultSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("InsultSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
