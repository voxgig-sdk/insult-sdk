...
describe("InsultformatDirect", function()
  it("should direct-load-insultformat", function()
    local setup = insultformat_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-insultformat", setup.live and "live" or "unit")
...
function insultformat_direct_setup(mockres)
