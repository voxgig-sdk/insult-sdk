...
describe("InsultDirect", function()
  it("should direct-load-insult", function()
    local setup = insult_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-insult", setup.live and "live" or "unit")
...
function insult_direct_setup(mockres)
