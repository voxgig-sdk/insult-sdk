...
describe("AdjectiveDirect", function()
  it("should direct-load-adjective", function()
    local setup = adjective_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-adjective", setup.live and "live" or "unit")
...
function adjective_direct_setup(mockres)
