...
describe("AdjectiveformatDirect", function()
  it("should direct-load-adjectiveformat", function()
    local setup = adjectiveformat_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-adjectiveformat", setup.live and "live" or "unit")
...
function adjectiveformat_direct_setup(mockres)
