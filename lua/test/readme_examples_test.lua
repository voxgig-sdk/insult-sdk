...
-- data to return.
local TEST_SEED = '{ entity = { ["adjective"] = { ["test01"] = { id = "test01" } }, ["adjectiveformat"] = { ["test01"] = { id = "test01" } }, ["insult"] = { ["test01"] = { id = "test01" } }, ["insultformat"] = { ["test01"] = { id = "test01" } } } }'
