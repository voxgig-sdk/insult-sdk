...
local AdjectiveEntity = {}
AdjectiveEntity.__index = AdjectiveEntity


function AdjectiveEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdjectiveEntity)
...
function AdjectiveEntity:get_name()
  return self._name
end


function AdjectiveEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdjectiveEntity.new(self._client, opts)
end
...
function AdjectiveEntity:mark_deleted()
  self._deleted = true
end


function AdjectiveEntity:deleted()
  return true == self._deleted
end


function AdjectiveEntity:data_set(args)
  if args ~= nil then
...
function AdjectiveEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdjectiveEntity:match_set(args)
  if args ~= nil then
...
function AdjectiveEntity:match_get()
...
function AdjectiveEntity:stream(action, args, callopts)
...
function AdjectiveEntity:_run_op(ctx, post_done)
  local utility = self._utility
