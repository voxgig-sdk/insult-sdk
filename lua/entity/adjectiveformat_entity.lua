...
local AdjectiveformatEntity = {}
AdjectiveformatEntity.__index = AdjectiveformatEntity


function AdjectiveformatEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdjectiveformatEntity)
  self._name = "adjectiveformat"
  self._client = client
...
function AdjectiveformatEntity:get_name()
  return self._name
end


function AdjectiveformatEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdjectiveformatEntity.new(self._client, opts)
end
...
function AdjectiveformatEntity:mark_deleted()
  self._deleted = true
end


function AdjectiveformatEntity:deleted()
  return true == self._deleted
end


function AdjectiveformatEntity:data_set(args)
  if args ~= nil then
...
function AdjectiveformatEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdjectiveformatEntity:match_set(args)
  if args ~= nil then
...
function AdjectiveformatEntity:match_get()
...
function AdjectiveformatEntity:stream(action, args, callopts)
...
---@param reqmatch AdjectiveformatLoadMatch
---@param ctrl? table
---@return Adjectiveformat
---@return string? err
function AdjectiveformatEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AdjectiveformatEntity:_run_op(ctx, post_done)
  local utility = self._utility
