...
local InsultformatEntity = {}
InsultformatEntity.__index = InsultformatEntity


function InsultformatEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, InsultformatEntity)
  self._name = "insultformat"
  self._client = client
...
function InsultformatEntity:get_name()
  return self._name
end


function InsultformatEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return InsultformatEntity.new(self._client, opts)
end
...
function InsultformatEntity:mark_deleted()
  self._deleted = true
end


function InsultformatEntity:deleted()
  return true == self._deleted
end


function InsultformatEntity:data_set(args)
  if args ~= nil then
...
function InsultformatEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function InsultformatEntity:match_set(args)
  if args ~= nil then
...
function InsultformatEntity:match_get()
...
function InsultformatEntity:stream(action, args, callopts)
...
function InsultformatEntity:_run_op(ctx, post_done)
  local utility = self._utility
