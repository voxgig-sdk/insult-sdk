...
InsultSDK._make_feature = _make_feature


function InsultSDK.new(options)
  local self = setmetatable({}, InsultSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function InsultSDK:options_map()
...
function InsultSDK:get_utility()
  return Utility.copy(self._utility)
end


function InsultSDK:get_root_ctx()
  return self._rootctx
end


function InsultSDK:prepare(fetchargs)
...
function InsultSDK:direct(fetchargs)
...
-- by passing it.
function InsultSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function InsultSDK:graphql(query, variables, ctrl)
...
function InsultSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = InsultSDK.new(sdkopts)
  sdk.mode = "test"
