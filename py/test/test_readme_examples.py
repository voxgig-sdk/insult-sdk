# Insult SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions InsultSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both InsultSDK(...) and InsultSDK.test(...) become
#      InsultSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "insult_sdk"
_SDK_CLASS = "InsultSDK"
...
_ENTITIES = {
    "Adjective": "adjective",
    "Adjectiveformat": "adjectiveformat",
    "Insult": "insult",
    "Insultformat": "insultformat",
}
