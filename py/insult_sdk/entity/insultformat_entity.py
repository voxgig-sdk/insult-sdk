...
class InsultformatEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return InsultformatEntity(self._client, opts)
    ...
    def data_get(self) -> Insultformat:
    ...
    def match_get(self) -> Insultformat:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Insultformat:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Insultformat().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
