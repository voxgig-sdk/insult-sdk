...
from insult_sdk.insult_types import (
    Adjectiveformat,
...
class AdjectiveformatEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdjectiveformatEntity(self._client, opts)
    ...
    def data_get(self) -> Adjectiveformat:
    ...
    def match_get(self) -> Adjectiveformat:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Adjectiveformat:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Adjectiveformat().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
