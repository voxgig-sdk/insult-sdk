...
from insult_sdk.utility import register

# Load features
from insult_sdk.feature.base_feature import InsultBaseFeature
from insult_sdk.features import _make_feature
...
class InsultSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = InsultUtility()
        self._utility = utility

        from insult_sdk.config import make_config
        config = make_config()
    ...
    def get_utility(self):
        return InsultUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("InsultSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Adjective(self, data=None) -> "AdjectiveEntity":
        ...
        from insult_sdk.entity.adjective_entity import AdjectiveEntity
    ...
    def Adjectiveformat(self, data=None) -> "AdjectiveformatEntity":
        ...
        from insult_sdk.entity.adjectiveformat_entity import AdjectiveformatEntity
    ...
    def Insult(self, data=None) -> "InsultEntity":
        ...
        from insult_sdk.entity.insult_entity import InsultEntity
    ...
    def Insultformat(self, data=None) -> "InsultformatEntity":
        ...
        from insult_sdk.entity.insultformat_entity import InsultformatEntity
