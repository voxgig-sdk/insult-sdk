...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Adjective()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/insult-sdk/releases)) or
