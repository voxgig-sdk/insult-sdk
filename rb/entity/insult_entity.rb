...
class InsultEntity
  ...
  # @return [Insult, Hash] the current Insult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Insult fields)
  def match_get
  ...
  #
  # @param reqmatch [InsultLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Insult.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Insult, Hash] the loaded Insult; raises InsultError on failure
