...
class AdjectiveformatEntity
  ...
  def make
    opts = @_entopts.dup
    AdjectiveformatEntity.new(@_client, opts)
  end
  ...
  # @return [Adjectiveformat, Hash] the current Adjectiveformat data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Adjectiveformat fields)
  def match_get
