...
class AdjectiveEntity
  ...
  def make
    opts = @_entopts.dup
    AdjectiveEntity.new(@_client, opts)
  end
  ...
  # @return [Adjective, Hash] the current Adjective data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Adjective fields)
  def match_get
  ...
  #
  # @param reqmatch [AdjectiveLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Adjective.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Adjective, Hash] the loaded Adjective; raises InsultError on failure
