...
module InsultTestRunner
  ...
  def self.env_override(m)
    live = getenv("INSULT_TEST_LIVE")
    override = getenv("INSULT_TEST_OVERRIDE")
    ...
    explain = getenv("INSULT_TEST_EXPLAIN")
    m["INSULT_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = InsultTestRunner
Helpers = InsultHelpers
Vs = VoxgigStruct
