...
from projectname_sdk.core.control import InsultControl
...
class InsultContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, InsultResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return InsultError(code, msg, self)
