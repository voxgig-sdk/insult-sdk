...
class InsultTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = InsultTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = InsultTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = InsultTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
