...
class InsultTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = InsultTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = InsultTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = InsultTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
