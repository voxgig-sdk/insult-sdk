# Insult SDK primary utility test
...
from projectname_sdk import InsultSDK
from projectname_sdk.core.spec import InsultSpec
from projectname_sdk.core.result import InsultResult
from projectname_sdk.core.response import InsultResponse
from projectname_sdk.core.operation import InsultOperation
from projectname_sdk.core.error import InsultError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import InsultBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = InsultSDK.test(None, None)
        ...
        class TestInitFeature(InsultBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(InsultBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = InsultSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = InsultSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = InsultSDK.test(None, setup_opts)
