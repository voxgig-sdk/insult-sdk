...
class InsultRatelimitFeature extends InsultBaseFeature
{
    ...
    private function _acquire(InsultContext $ctx): void
    {
    ...
    private function _track(InsultContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
