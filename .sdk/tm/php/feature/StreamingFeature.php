...
class InsultStreamingFeature extends InsultBaseFeature
{
    ...
    private function _iterate(InsultResult $result): \Generator
    {
    ...
    private function _streamable(InsultContext $ctx): bool
    {
