...
class InsultTimeoutFeature extends InsultBaseFeature
{
    ...
    private function _with_timeout(InsultContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(InsultContext $_ctx, float $ms): void
    {
        $client = $this->client;
