...
// Insult SDK clienttrack feature
...
class InsultClienttrackFeature extends InsultBaseFeature
{
    ...
    public function PostConstruct(InsultContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Insult-SDK';
