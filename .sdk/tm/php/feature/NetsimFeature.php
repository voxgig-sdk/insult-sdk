...
class InsultNetsimFeature extends InsultBaseFeature
{
    ...
    private function _simulate(InsultContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(InsultContext $ctx, array $applied): void
    {
        $client = $this->client;
