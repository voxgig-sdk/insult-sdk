...
class InsultCacheFeature extends InsultBaseFeature
{
    ...
    private function _through(InsultContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
