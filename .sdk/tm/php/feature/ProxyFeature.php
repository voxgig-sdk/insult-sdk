...
class InsultProxyFeature extends InsultBaseFeature
{
    ...
    public function init(InsultContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (InsultContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
