...
class InsultFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; InsultSDK/1.0)';
    ...
    public static function call(InsultContext $ctx, string $fullurl, array $fetchdef): array
    {
