...
// Insult SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class InsultMakeRequest
{
    public static function call(InsultContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new InsultResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new InsultResponse($fetched);
        } else {
