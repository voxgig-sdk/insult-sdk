...
func registerSDKWords(r *eng.Registry, client *sdk.InsultSDK) {
...
func runOp(client *sdk.InsultSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
